					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<s:param name="value"><s:date name="visit_time" format="yyyy-MM-dd" /></s:param>
								</s:textfield>
								</td>
								<td>拜访地点 ：</td>
								<td>
							...
							<TR>
								...
								<s:param name="value"><s:date name="visit_nexttime" format="yyyy-MM-dd" /></s:param>
								</s:textfield>
								</td>
							</TR>
...
$(function(){
	...
	$.post("${pageContext.request.contextPath}/user_findAllUser.action",function(data){
		...
		$("#user option[value='${model.user.user_id}']").attr("selected","selected");
	},"json");
});
