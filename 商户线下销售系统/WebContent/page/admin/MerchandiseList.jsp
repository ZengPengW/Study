		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="#">在售商品 <span class="sr-only">(current)</span></a>
					</li>
		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-7">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="请输入你要搜索的商品名称"> <span
						class="input-group-btn">
						<button class="btn btn-warning" type="button" >搜索商品</button>
					</span>
				</div>
