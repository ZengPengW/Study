	...
	<div class="container">
		<form role="form" class="form-horizontal "
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" style="display: none" value="${product.pid}"
						id="pid" name="pid"> <input type="text"
						class="form-control" id="productName" placeholder="请输入商品名称"
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="productClass"
						placeholder="分类名字相同的商品会被分在一起" name="productClass"
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="price"
						placeholder="请输入商品价格" name="price" value="${product.price }">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="productCount"
						placeholder="请输入商品数量" name="productCount"
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<img class="img-rounded img-thumbnail" width="140px" height="140px"
						src="${product.productImg }" id="spimg" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					...
					<textarea cols="20" rows="5" data-first="true" id="productMessage"
						name="productMessage">${product.productMessage }</textarea>
			...
			<div class="form-group">
				<div class="col-xs-offset-2 col-sm-10 ">
					<button type="submit"
						style="width: 80%; height: 40px; background-color: red; font-size: 20px; color: white;"
