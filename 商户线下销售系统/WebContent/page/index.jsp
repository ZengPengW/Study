	...
	<div class="container">
		<table class="table table-striped table-responsive">
			...
			<tr class=" success">
				...
				<td>
					<h2>
						<strong><%=String.format("%.2f", Double.valueOf(finance.getBalance()))%></strong>
					</h2>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<h2>
						<strong><%=String.format("%.2f", Double.valueOf(finance.getSoldout()))%></strong>
					</h2>
				</td>
			</tr>
...
<script>var uid="${user.id}a1"+new Date().getTime();</script>
