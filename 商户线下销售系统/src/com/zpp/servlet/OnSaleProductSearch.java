...
/**
 * Servlet implementation class OnSaleProductSearch
 */
...
public class OnSaleProductSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(!likeName.isEmpty())products=service.GetOnSaleByName(likeName, user.getId());
			else   products=service.OnSaleProductByID(user.getId(), 1, "È«²¿");
